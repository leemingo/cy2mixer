...
class TrafficStateExecutor(AbstractExecutor):
    def __init__(self, config, model, data_feature):
        ...
        self.cache_dir = '/data/mm/libcity/cache/{}/model_cache'.format(self.exp_id)
        self.evaluate_res_dir = '/data/mm/libcity/cache/{}/evaluate_cache'.format(self.exp_id)
        self.summary_writer_dir = '/data/mm/libcity/cache/{}/'.format(self.exp_id)
